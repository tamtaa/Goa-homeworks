...
#optical character recognition software for scanning in the text of old novels to your database. 
#At first it seems to capture words okay, but you quickly notice that it throws in a lot of
...
#take this garbled text and remove all of the numbers. 
